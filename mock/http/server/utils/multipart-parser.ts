...
function lower(c: number) {
  return c | 0x20;
}

class MultipartParser extends Transform {

  public static stateToString(stateNumber: number): string | void  {
  ...
  public initWithBoundary(str: string): void {
  ...
  private _handleCallback(name, buf, start, end): void {
  ...
  public _transform(buffer, _, done) {
    let i = 0;
